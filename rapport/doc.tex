...
\begin{table}[!h]
    ...
    % Disclaimer sur le fait que nos moyennes relatent de l'info sur le corpus associé à une langue et non sur la langue elle-même.
    ...
    % Bibliography :
    % [1] Parkvall, M. 2008. The Simplicity of Creoles in a Cross-Linguistic Perspective. Stockholms Universitet. Accessed Oct. 2021.
    % [2] Wisniewski G., Yvon, F. 2018. Divergences entre annotations dans le projet Universal Dependencies et leur impact sur l’évaluation de l’étiquetage morpho-syntaxique. Conférence sur le Traitement Automatique des Langues Naturelles. Accessed Oct. 2021.
    % [3] Dickinson, M., Meurers, W. D. 2003. Detecting errors in part-of-speech annotation. In Proceedings of the Tenth Conference on European Chapter of the Association for Computational Linguistics - Volume 1, EACL ’03, p. 107–114, Stroudsburg, PA, USA : Association for Computational Linguistics.
    % [4] Nivre, J., Agić Z., Ahrenberg L. et al. 2017. Universal dependencies 2.1. LINDAT/CLARIN digital library at the Institute of Formal and Applied Linguistics (ÚFAL), Faculty of Mathematics and Physics, Charles University.
