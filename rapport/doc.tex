...
\begin{table}[!h]
    ...
    % Bibliography :
    % Parkvall, M. 2008. The Simplicity of Creoles in a Cross-Linguistic Perspective. Stockholms Universitet. Accessed Oct. 2021.
    % Wisniewski G., Yvon, F. 2018 .Divergences entre annotations dans le projet Universal Dependencies et leur impact sur l’évaluation de l’étiquetage morpho-syntaxique. Conférence sur le Traitement Automatique des Langues Naturelles. Accessed Oct. 2021.
